...
public class Calculadora extends javax.swing.JFrame {
    ...
    private double operadorUno, operadorDos, resultado;
    ...
    // Metodo verificar numero
    public double esNumero() {
        String numero = "";
        boolean esNumerico = false;
        do {

            numero = cadenaNumeros;
    ...
    private void initComponents() {
        ...
        botonClear.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        ...
        botonProduct.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        botonProduct.setText("x");
        ...
        gridBagConstraints.weightx = 0.5;
        gridBagConstraints.weighty = 0.5;
        panel.add(botonProduct, gridBagConstraints);
    ...
    private void botonIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIgualActionPerformed
        if (operacion.equals("nula")) {
            ...
            if (operadorUno != 0 && operadorDos != 0) {
                ...
                etiquetaNumeros.setText("Operacion incorrecta");
            }
            etiquetaNumeros.setText(String.format("%.2f", resultado));
            cadenaNumeros = String.valueOf(resultado);
            operacion = "nula";
    ...
    private void botonBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBorrarActionPerformed
        int largo = cadenaNumeros.length();
        if (largo > 0) {
            if (largo == 1) {
                cadenaNumeros = "0";
            } else {
    ...
    private void botonRestarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRestarActionPerformed
        if (activado) {
            operadorUno = Double.parseDouble(cadenaNumeros);
            etiquetaMuestra.setText(cadenaNumeros + "-");
            cadenaNumeros = "";
            operacion = "restar";
            activado = false;
    ...
    private void botonRaizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRaizActionPerformed
        if (activado) {
            ...
            resultado = Math.sqrt(operadorUno);
            etiquetaNumeros.setText(String.format("%.2f", resultado));
            cadenaNumeros = String.valueOf(resultado);
            punto = true;
        }
