...
public class Principal {
    ...
    // Numero de aerpuertos
    final static int numAeropuerto = 2;
    ...
    public static void insertarDatos(Aeropuerto aero[]) {
        ...
        // Crear compañia e insertar
        aero[0].insertarCompania(new Compania("Aero$hule"));
        // Crear compañia
        aero[0].insertarCompania(new Compania("Eskai"));

        // Verificamos si la compañia existe y se inserta un nuevo areglo.
        ...
        // Verificar compañia, el id del vuelo e insertar pasajero.
        aero[0].getCompania("Aero$hule").getvuelo("SH12").insertarPasajero(new Pasajero("marlon", "asd123", "$huleno"));

        // Crear aeropurto privado
        aero[1] = new AeropuertoPrivado("AeroCuico", "santiasco", "chule");
        // Crear compañia e insertar
        aero[1].insertarCompania(new Compania("$hules cuicos"));
        // Crear nueva compañia
        aero[1].insertarCompania(new Compania("Eskai premium"));

        // Insertar empresa
        String empresas[] = {"litioVendio", "cobreRobao"};        
        // Se realiza un downcast para acceder al metodo de la clase hija empresas
        ...
        // Verificar compañia, id del vuelo e insertar pasajero
        ...
        do {
            ...
            switch (op) {
                ...
                case 3:
                    ...
                    // Preguntamos el nombre de la compañía que desea buscar.
                    nomAero = scanner.nextLine();
                    ...
                    if (aero == null) { // Condicional
                        ...
                        // Lista De Compañías Por Aeropuerto
                ...
                case 4:
                    scanner.nextLine();
                    System.out.println("\n Digite el nombre del aeropuerto: ");
                    nomAero = scanner.nextLine(); // Preguntamos El Nombre De La Compañía Que Desea Buscar
                    aero = listaVuelosAeropuerto(nomAero, aeropuerto);

                    if (aero == null) { // Condicional
                        System.out.print("El aeropuerto buscado no existe");
                    } else {
                        // Lista De Vuelos Por Compañía
